...
namespace OpenUtau.App.ViewModels {
    class TrackSettingsViewModel : ViewModelBase {
        ...
        public void SetDefaultResampler() {
            if (Resampler != null) {
                Preferences.Default.DefaultResamplers[Track.RendererSettings.renderer] = Resampler.ToString();
                Preferences.Save();
            }
        }
        ...
        public void SetDefaultWavtool() {
            if (Wavtool != null) {
                Preferences.Default.DefaultWavtools[Track.RendererSettings.renderer] = Wavtool.ToString();
                Preferences.Save();
            }
        }
        ...
        public void Finish() {
            ...
            settings.resampler = Resampler?.ToString();
            settings.wavtool = Wavtool?.ToString();
