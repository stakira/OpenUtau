...
namespace OpenUtau.App {
    ...
    class ThemeManager {
        ...
        public static List<TrackColor> TrackColors = new List<TrackColor>(){
                ...
                new TrackColor("Orange", "#FF8A65", "#FF7043", "#FFAB91"),
                new TrackColor("Yellow", "#FBC02D", "#F9A825", "#FDD835"),
                new TrackColor("Light Green", "#CDDC39", "#C0CA33", "#DCE775"),
                ...
                new TrackColor("Orange2", "#FF5722", "#E64A19", "#FF7043"),
                new TrackColor("Yellow2", "#FF8F00", "#FF7F00", "#FFB300"),
                new TrackColor("Light Green2", "#AFB42B", "#9E9D24", "#CDDC39"),
                new TrackColor("Green2", "#2E7D32", "#1B5E20", "#43A047"),
