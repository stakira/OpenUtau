; Version: 1.1
; Credit: DELTA SYNTH & Gemini, UTAU THAILAND, stakira
...
; --- Thai UI Credit Localization ---
; กำหนดข้อความเครดิตสำหรับภาษาไทยโดยเฉพาะ
LangString UI_CREDIT ${LANG_THAI} "UI Thai By UTAU THAILAND"
LangString UI_CREDIT ${LANG_ENGLISH} ""

; Welcome page
!define MUI_WELCOMEPAGE_TEXT "This wizard will guide you through the installation of $(^Name).$\r$\n$\r$\n$(UI_CREDIT)"
