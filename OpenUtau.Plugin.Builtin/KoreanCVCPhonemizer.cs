...
namespace OpenUtau.Plugin.Builtin {
    ...
    public class KoreanCVCPhonemizer : Phonemizer {
        ...
        static readonly string[] vowels = new string[] {
            ...
            "a=ga,na,da,ra,la,ma,ba,sa,a,ja,cha,ka,ta,pa,ha,gga,dda,bba,ssa,jja,gya,nya,dya,rya,lya,mya,bya,sya,ya,jya,chya,kya,tya,pya,hya,ggya,ddya,bbya,ssya,jjya,gwa,nwa,dwa,rwa,lwa,mwa,bwa,swa,wa,jwa,chwa,kwa,twa,pwa,hwa,ggwa,ddwa,bbwa,sswa,jjwa,가,나,다,라,ㄹ라마,바,사,아,자,차,카,타,파,하,까,따,빠,싸,짜,갸,냐,댜,랴,ㄹ랴,먀,뱌,샤,야,쟈,챠,캬,탸,퍄,햐,꺄,땨,뺘,쌰,쨔,과,놔,돠,롸,ㄹ롸,뫄,봐,솨,와,좌,촤,콰,톼,퐈,화",
        ...
        static readonly string[] consonants = new string[] {
            ...
            "jj=jj,jja,jji,jju,jje,jjo,jjeu,jjeo,jjya,jjyu,jjye,jjyo,jjyeo,jjwa,jjwi,jjwe,jjweo,ㅉ,짜,찌,쭈,쩨,째,쪼,쯔,쩌,쨔,쮸,쪠,쨰,쬬,쪄,쫘,쮜,쮀,쫴,쬐,쭤",
