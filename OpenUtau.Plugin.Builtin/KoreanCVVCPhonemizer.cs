...
namespace OpenUtau.Plugin.Builtin
{
    ...
    public class KoreanCVVCPhonemizer : Phonemizer
    {
        ...
        static readonly string[] vowels = new string[] {
            "a=a,ya,wa,가,나,다,라,마,바,사,아,자,차,카,타,파,하,까,따,빠,싸,짜,갸,냐,댜,랴,먀,뱌,샤,야,쟈,챠,캬,탸,퍄,햐,꺄,땨,뺘,쌰,쨔,과,놔,돠,롸,뫄,봐,솨,좌,촤,콰,톼,퐈,화,꽈,똬,뽜,쏴,쫘",
            "e=e,ye,we,게,네,데,레,메,베,세,에,제,체,케,테,페,헤,께,떼,뻬,쎄,쩨,계,녜,뎨,례,몌,볘,셰,예,졔,쳬,켸,톄,폐,혜,꼐,뗴,뼤,쎼,쪠,개,내,대,래,매,배,새,애,재,채,캐,태,패,해,깨,때,빼,쌔,째,걔,냬,댸,럐,먜,뱨,섀,얘,쟤,챼,컈,턔,퍠,햬,꺠,떄,뺴,썌,쨰,괘,놰,돼,뢔,뫠,봬,쇄,왜,좨,쵀,쾌,퇘,퐤,홰,궤,눼,뒈,뤠,뭬,붸,쉐,웨,줴,췌,퀘,퉤,풰,훼,꿰,뛔,쀄,쒜,쮀,괴,뇌,되,뢰,뫼,뵈,쇠,외,죄,최,쾨,퇴,푀,회,꾀,뙤,뾔,쐬,쬐",
            "i=i,wi,eui기,니,디,리,미,비,시,이,지,치,키,티,피,히,끼,띠,삐,씨,찌,귀,뉘,뒤,뤼,뮈,뷔,쉬,위,쥐,취,퀴,튀,퓌,휘,뀌,뛰,쀠,쒸,쮜,긔,늬,듸,릐,믜,븨,싀,의,즤,츼,킈,틔,픠,희,끠,띄,쁴,씌,쯰",
