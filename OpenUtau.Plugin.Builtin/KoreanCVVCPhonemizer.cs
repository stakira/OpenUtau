...
namespace OpenUtau.Plugin.Builtin
{
    ...
    public class KoreanCVVCPhonemizer : Phonemizer
    {
        ...
        static readonly string[] vowels = new string[] {
            "a=a,ya,wa,가,나,다,라,ㄹ라,마,바,사,아,자,차,카,타,파,하,까,따,빠,싸,짜,갸,냐,댜,랴,ㄹ랴,먀,뱌,샤,야,쟈,챠,캬,탸,퍄,햐,꺄,땨,뺘,쌰,쨔,과,놔,돠,롸,ㄹ롸,뫄,봐,솨,좌,촤,콰,톼,퐈,화,꽈,똬,뽜,쏴,쫘",
            "e=e,ye,we,게,네,데,레,ㄹ레,메,베,세,에,제,체,케,테,페,헤,께,떼,뻬,쎄,쩨,계,녜,뎨,례,ㄹ례,몌,볘,셰,예,졔,쳬,켸,톄,폐,혜,꼐,뗴,뼤,쎼,쪠,개,내,대,래,ㄹ래,매,배,새,애,재,채,캐,태,패,해,깨,때,빼,쌔,째,걔,냬,댸,럐,ㄹ럐,먜,뱨,섀,얘,쟤,챼,컈,턔,퍠,햬,꺠,떄,뺴,썌,쨰,괘,놰,돼,뢔,뫠,봬,쇄,왜,좨,쵀,쾌,퇘,퐤,홰,궤,눼,뒈,뤠,ㄹ뤠,뭬,붸,쉐,웨,줴,췌,퀘,퉤,풰,훼,꿰,뛔,쀄,쒜,쮀,괴,뇌,되,뢰,ㄹ뢰,뫼,뵈,쇠,외,죄,최,쾨,퇴,푀,회,꾀,뙤,뾔,쐬,쬐",
            "i=i,wi,eui,기,니,디,리,ㄹ리,미,비,시,이,지,치,키,티,피,히,끼,띠,삐,씨,찌,귀,뉘,뒤,뤼,ㄹ뤼,뮈,뷔,쉬,위,쥐,취,퀴,튀,퓌,휘,뀌,뛰,쀠,쒸,쮜,긔,늬,듸,릐,ㄹ릐,믜,븨,싀,의,즤,츼,킈,틔,픠,희,끠,띄,쁴,씌,쯰",
            "o=o,yo,고,노,도,로,모,보,소,오,조,초,코,토,포,호,꼬,또,뽀,쏘,쪼,교,뇨,됴,료,묘,뵤,쇼,요,죠,쵸,쿄,툐,표,효,꾜,뚀,뾰,쑈,쬬",
            "u=u,yu,구,누,두,루,무,부,수,우,주,추,쿠,투,푸,후,꾸,뚜,뿌,쑤,쭈,규,뉴,듀,류,뮤,뷰,슈,유,쥬,츄,큐,튜,퓨,휴,뀨,뜌,쀼,쓔,쮸",
            "eu=eu,그,느,드,르,므,브,스,으,즈,츠,크,트,프,흐,끄,뜨,쁘,쓰,쯔",
            "eo=eo,yeo,weo,거,너,더,러,머,버,서,어,저,처,커,터,퍼,허,꺼,떠,뻐,써,쩌,궈,눠,둬,뤄,뭐,붜,숴,워,줘,춰,쿼,퉈,풔,훠,꿔,뚸,뿨,쒀,쭤",
            "N=N,ㄴ",
            "M=M,ㅁ",
            "NG=NG,ㅇ",
            "L=L,ㄹ",
