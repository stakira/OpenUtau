...
namespace OpenUtau.Plugin.Builtin {
    ...
    public class JapaneseVCVPhonemizer : Phonemizer {
        ...
        static readonly string[] vowels = new string[] {
            "a=ぁ,あ,か,が,さ,ざ,た,だ,な,は,ば,ぱ,ま,ゃ,や,ら,わ,ァ,ア,カ,ガ,サ,ザ,タ,ダ,ナ,ハ,バ,パ,マ,ャ,ヤ,ラ,ワ,a,ka,ga,sa,za,ta,da,na,ha,ba,pa,ma,ya,ra,wa,la,ja,va",
            "e=ぇ,え,け,げ,せ,ぜ,て,で,ね,へ,べ,ぺ,め,れ,ゑ,ェ,エ,ケ,ゲ,セ,ゼ,テ,デ,ネ,ヘ,ベ,ペ,メ,レ,ヱ,e,ke,ge,se,ze,te,de,ne,he,be,pe,me,ye,re,we,le,je,ve",
            "i=ぃ,い,き,ぎ,し,じ,ち,ぢ,に,ひ,び,ぴ,み,り,ゐ,ィ,イ,キ,ギ,シ,ジ,チ,ヂ,ニ,ヒ,ビ,ピ,ミ,リ,ヰ,i,ki,gi,zi,ti,di,ni,hi,bi,pi,mi,yi,si,ri,wi,li,ji,vi",
            "o=ぉ,お,こ,ご,そ,ぞ,と,ど,の,ほ,ぼ,ぽ,も,ょ,よ,ろ,を,ォ,オ,コ,ゴ,ソ,ゾ,ト,ド,ノ,ホ,ボ,ポ,モ,ョ,ヨ,ロ,ヲ,o,ko,go,so,zo,to,do,no,ho,bo,po,mo,yo,ro,wo,lo,jo,vo",
            "n=ん,n",
            "u=ぅ,う,く,ぐ,す,ず,つ,づ,ぬ,ふ,ぶ,ぷ,む,ゅ,ゆ,る,ゥ,ウ,ク,グ,ス,ズ,ツ,ヅ,ヌ,フ,ブ,プ,ム,ュ,ユ,ル,ヴ,u,ku,gu,su,zu,tu,du,nu,hu,bu,pu,mu,yu,ru,wu,lu,ju,vu",
            "N=ン,ng",
        };
