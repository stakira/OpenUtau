...
namespace OpenUtau.Plugin.Builtin {
    ...
    public class ItalianCVVCPhonemizer : Phonemizer {
        ...
        static readonly string[] consonants = new string[] {
            "p=pa,pe,pi,po,pu,p3,p0,pya,pye,pyi,pyo,pyu,py3,py0,pwa,pwe,pwi,pwo,pwu,pw3,pw0",
            "b=ba,be,bi,bo,bu,b3,b0,bya,bye,byi,byo,byu,by3,by0,bwa,bwe,bwi,bwo,bwu,bw3,bw0",
            "t=ta,te,ti,to,tu,t3,t0,tya,tye,tyi,tyo,tyu,ty3,ty0,twa,twe,twi,two,twu,tw3,tw0",
            "d=da,de,di,do,du,d3,d0,dya,dye,dyi,dyo,dyu,dy3,dy0,dwa,dwe,dwi,dwo,dwu,dw3,dw0",
            "k=ka,ke,ki,ko,ku,k3,k0,kya,kye,kyi,kyo,kyu,ky3,ky0,kwa,kwe,kwi,kwo,kwu,kw3,kw0",
            "g=ga,ge,gi,go,gu,g3,g0,gya,gye,gyi,gyo,gyu,gy3,gy0,gwa,gwe,gwi,gwo,gwu,gw3,gw0",
            "ts=tsa,tse,tsi,tso,tsu,ts3,ts0,tsya,tsye,tsyi,tsyo,tsyu,tsy3,tsy0,tswa,tswe,tswi,tswo,tswu,tsw3,tsw0",
            "dz=dza,dze,dzi,dzo,dzu,dz3,dz0,dzya,dzye,dzyi,dzyo,dzyu,dzy3,dzy0,dzwa,dzwe,dzwi,dzwo,dzwu,dzw3,dzw0",
            "tS=tSa,tSe,tSi,tSo,tSu,tS3,tS0,tSya,tSye,tSyi,tSyo,tSyu,tSy3,tSy0,tSwa,tSwe,tSwi,tSwo,tSwu,tSw3,tSw0",
            "dZ=dZa,dZe,dZi,dZo,dZu,dZ3,dZ0,dZya,dZye,dZyi,dZyo,dZyu,dZy3,dZy0,dZwa,dZwe,dZwi,dZwo,dZwu,dZw3,dZw0",
            "f=fa,fe,fi,fo,fu,f3,f0,fya,fye,fyi,fyo,fyu,fy3,fy0,fwa,fwe,fwi,fwo,fwu,fw3,fw0",
            "v=va,ve,vi,vo,vu,v3,v0,vya,vye,vyi,vyo,vyu,vy3,vy0,vwa,vwe,vwi,vwo,vwu,vw3,vw0",
            "s=sa,se,si,so,su,s3,s0,sya,sye,syi,syo,syu,sy3,sy0,swa,swe,swi,swo,swu,sw3,sw0",
            "z=za,ze,zi,zo,zu,z3,z0,zya,zye,zyi,zyo,zyu,zy3,zy0,zwa,zwe,zwi,zwo,zwu,zw3,zw0",
            "S=Sa,Se,Si,So,Su,S3,S0,Sya,Sye,Syi,Syo,Syu,Sy3,Sy0,Swa,Swe,Swi,Swo,Swu,Sw3,Sw0",
            "r=ra,re,ri,ro,ru,r3,r0,rya,rye,ryi,ryo,ryu,ry3,ry0,rwa,rwe,rwi,rwo,rwu,rw3,rw0",
            "l=la,le,li,lo,lu,l3,l0,lya,lye,lyi,lyo,lyu,ly3,ly0,lwa,lwe,lwi,lwo,lwu,lw3,lw0",
            "j=ja,je,ji,jo,ju,j3,j0,jya,jye,jyi,jyo,jyu,jy3,jy0,jwa,jwe,jwi,jwo,jwu,jw3,jw0",
            "y=ya,ye,yi,yo,yu,y3,y0,ywa,ywe,ywi,ywo,ywu,yw3,yw0",
            "w=wa,we,wi,wo,wu,w3,w0",
            "n=na,ne,ni,no,nu,n3,n0,nya,nye,nyi,nyo,nyu,ny3,ny0,nwa,nwe,nwi,nwo,nwu,nw3,nw0",
            "m=ma,me,mi,mo,mu,m3,m0,mya,mye,myi,myo,myu,my3,my0,mwa,mwe,mwi,mwo,mwu,mw3,mw0",
            "gn=gna,gne,gni,gno,gnu,gn3,gn0",
            "N=Na,Ne,Ni,No,Nu,N3,N0,Nya,Nye,Nyi,Nyo,Nyu,Ny3,Ny0,Nwa,Nwe,Nwi,Nwo,Nwu,Nw3,Nw0",
            "M=Ma,Me,Mi,Mo,Mu,M3,M0,Mya,Mye,Myi,Myo,Myu,My3,My0,Mwa,Mwe,Mwi,Mwo,Mwu,Mw3,Mw0",
            "R=R",
            "-=-"
