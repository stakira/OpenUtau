...
namespace OpenUtau.Plugin.Builtin
{
    ...
    public class ENDeltaVer1Phonemizer : SyllableBasedPhonemizer
    {
        ...
        private readonly string[] vowels = "a,A,@,{,V,O,aU,aI,E,3,eI,I,i,oU,OI,U,u,Q,Ol,aUn,e@,eN,IN,e,o,Ar,Qr,Er,Ir,Or,Ur,ir,ur,aIr,aUr,A@,Q@,E@,e@,I@,O@,U@,i@,u@,aI@,aU@,@r,@l,@m,@n,@N,1,e@m,e@n".Split(',');
