...
namespace OpenUtau.Plugin.Builtin
{
    ...
    public class ENDeltaVer1Phonemizer : SyllableBasedPhonemizer
    {
        ...
        private readonly string[] vowels = "a,A,@,{,V,O,aU,aI,E,3,eI,I,i,oU,OI,U,u,Q,Ol,aU~,{~,eI~,I~,e,o,Ar,Er,Ir,Or,Ur,@l,@m,@n,@N,1,e@m,e@n,IN,l＝,m＝,n＝,N＝".Split(',');
                    ...
                    for (var i = 0; i < cc.Length - 1; i++) {
                        ...
                        if (i < cc.Length - 2) {
                            ...
                            if (HasOto(cc3, ending.tone)) {
                                ...
                                if (HasOto(cc1, ending.tone) && (!HasOto(vcc2, ending.tone))) {
                                    // like [C1 C2][C2 ...]
                                    phonemes.Add(cc1);
                                    ...
                                    // like [C1][C2 ...]
                                    if (burstConsonants.Contains(cc[i]) && (!HasOto(vcc2, ending.tone))) {
