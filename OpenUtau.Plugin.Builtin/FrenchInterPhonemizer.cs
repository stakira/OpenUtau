...
namespace OpenUtau.Plugin.Builtin {
    /// <summary>
    /// The French International Phonemizer.
    /// <para>
    ...
    /// </para>
    /// </summary>
    [Phonemizer("French International Phonemizer", "FR INT")]
    public class FrenchInterPhonemizer : Phonemizer {
        ...
        private void Initialize() {
            ...
            Task.Run(() => {
                ...
                string filepath = Path.Combine(PluginDir, "french.yaml");
                try {
                ...
                LoadSingerDict();
                mergedG2p = new G2pFallbacks(new IG2p[] { pluginDict, singerDict, new InterFRG2p() }.OfType<IG2p>().ToArray());
                // Arpasing voicebanks are often incomplete. A fallback table is used to slightly improve the situation.
                vowelFallback = "ii=ii;ei=ei;ai=ai;aa=aa;oo=oo;au=au;ou=ou;uu=uu;ee=ee;oe=oe;in=in;an=an;on=on".Split(';')
